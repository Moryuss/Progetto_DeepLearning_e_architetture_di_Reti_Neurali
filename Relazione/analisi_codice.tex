...
\begin{description}
    ...
    \item[Funzionalità:] Per ogni persona nel dataset, controlla se il numero di immagini \"aumentate\" è inferiore a una soglia e, in caso affermativo, ne genera di nuove.
